...
{
    public partial class PageEmployeeEdit : EmployeePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if(Ctrl.Bf.ProfessionalID > 0)
                Ctrl.updateEmployeeInfo(name,codeWorker,workNumber,personalNumber);
            else
                Ctrl.insertEmployeeInfo(name, codeWorker, workNumber, personalNumber);
