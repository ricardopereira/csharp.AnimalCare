<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="AnimalCare.Account.RegisterExternalLogin" %>
